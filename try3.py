    ...
    def connect_modbus(self):
        for i in self.reg_list:
            ...
            if self.sensorTypeNo == 1:
                regs = [16842, 33602, 16844, 13904, 16848, 36187, 16847, 4206, 16846, 15114]
            elif self.sensorTypeNo == 2:
                regs = [16842, 12657, 16825, 44575, 16832, 51500, 16830, 49161, 16842, 38676]
            elif self.sensorTypeNo == 3:
                regs = [16847, 27896, 16845, 58345, 16843, 32204, 16837, 57357, 16842, 25046]
            else:
                print("read error")
